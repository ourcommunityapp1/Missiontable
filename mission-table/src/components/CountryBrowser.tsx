...
import type { FeaturedCountry } from "@/lib/queries";

export default function CountryBrowser({ countries }: { countries: FeaturedCountry[] }) {
  return (
    <section className="bg-cream border-t-2 border-black px-6 md:px-16 py-16 md:py-24 overflow-hidden">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mb-8 md:mb-16">
          <h2 className="font-fraunces font-bold text-5xl md:text-[64px] uppercase tracking-[-0.03em] leading-[1.05] mb-3 fraunces-64">
          ...
          {countries.map((country) => (
            ...
            >
              ...
              <div className="flex items-baseline justify-between">
                <span className="font-fraunces font-bold text-3xl fraunces-32">{country.name}</span>
